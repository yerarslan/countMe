...
function getDocStats(fileContent) {
    ...
    var mostUsedWords = wordList.slice(0, 6);

    //return 5 least used words
    var leastUsedWords = wordList.slice(-6, wordList.lenght);
...
function sortProperties(object) {
    ...
    //sort the array based on repetition
...
function filterStopWords(wordArray) {
    ...
    for (commonWord of commonWords) {
        commonObj[commonWord.trim()] = true;
    }

    for (wordItem of wordArray) {
